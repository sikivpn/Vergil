...
curl -sS https://raw.githubusercontent.com/sikivpn/Vergil/main2/ssh/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/sikivpn/Vergil/main2/ssh/nginx.conf"
mkdir -p /home/vps/public_html
/etc/init.d/nginx restart

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/sikivpn/Vergil/main2/ssh/newudpgw"
...
wget https://raw.githubusercontent.com/sikivpn/Vergil/main2/ssh/bbr.sh && chmod +x bbr.sh && ./bbr.sh
...
wget -O up "https://raw.githubusercontent.com/sikivpn/Vergil/main/up.sh"
chmod +x menu
chmod +x menu-trial
chmod +x menu-vmess
chmod +x menu-vless

#!/bin/bash
BURIQ () {
    curl -sS https://raw.githubusercontent.com/sikivpn/Vergil/main/permission/ipmini > /root/tmp
...
export sem=$( curl -s https://raw.githubusercontent.com/sikivpn/Vergil/main/permission/versions)
export pak=$( cat /home/.ver)
IPVPS=$(curl -s ipinfo.io/ip )
clear
echo -e "                         ${BIWhite}${UWhite}About${NC}"
echo -e "                 ${BICyan}Base Script : ${BIPurple}Horassss${NC}"
echo -e "                 ${BICyan}Bot Dev     : ${BIPurple}@huutvpn${NC}"
echo -e "                 ${BICyan}Decodec     :${BIPurple} @huutvpn${NC}"
echo -e "                 ${BICyan}${On_IPurple}SCRIPT MULTI By ${UWhite}Siki Vpn${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
...
9) clear ; genssl ;;
10) clear ; jam ;;
6969) clear ; wget https://raw.githubusercontent.com/sikivpn/Vergil/main/update.sh && chmod +x update.sh && ./update.sh && rm -f /root/update.sh ;;
0) clear ; menu ;;
x) exit ;;

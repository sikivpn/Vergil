...
sleep 2
clear
wget https://raw.githubusercontent.com/sikivpn/Vergil/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
...
wget https://raw.githubusercontent.com/sikivpn/Vergil/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/sikivpn/Vergil/main/Tunnel/udp.sh && bash udp.sh
clear
cat> /root/.profile << END
# ~/.profile: executed by Bourne-compatible login shells.
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ Script Created By Siki Vpn]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
rm /root/setup.sh >/dev/null 2>&1
